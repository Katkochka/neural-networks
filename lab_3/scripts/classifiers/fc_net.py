...
class TwoLayerNet(object):
    ...
    def loss(self, X, y=None):
        ...
        caches = {}
        scores = X
        # Прямой проход для случая, если слой последний и если он не последний
    ...
    def train(self, X, y, X_val, y_val,
        ...
        for it in range(num_iters):
            ...
            # Случайная минипакетная выборка из обучающих данных и меток
            ...
            # Производим обновление параметров сети
            ...
            # Проверяем точность на обучающем и валидационном наборах и уменьшаем скорость обучения на каждой эпохе
    ...
    def predict(self, X):
        ...
        # Класс с наивысшей оценкой для каждой точки из данных
...
class FullyConnectedNet(object):
    ...
    def __init__(self, hidden_dims, input_dim=3 * 32 * 32, num_classes=10, 
        ...
        # Инициализация как и в случае 2-слойной сети
